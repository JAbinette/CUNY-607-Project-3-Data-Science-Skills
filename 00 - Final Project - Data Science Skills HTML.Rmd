...
user_name <- 'jenn' ##.rs.askForPassword("Enter the Database user name")
password <- 'coaststock1'  ##.rs.askForPassword("Enter the Database password")
